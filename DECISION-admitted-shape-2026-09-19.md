...
> `bench/results/v5-depth-ladder-2026-09-19/RESULTS-13NOTE-RERUN-2026-09-20.md`.
> Wall clock stayed worse for `single` at every rung measured, +26.9 % to +64.5 %.
...
- `bench/results/v5-depth-ladder-2026-09-19/` — the depth ladder: 41.8 % at 193K, the session limit that cut it
  short, and the check-id defect it found; `RESULTS-RERUN-2026-09-20.md` measures 43.1 % (285K) and 56.6 %
  (389K); `RESULTS-13NOTE-RERUN-2026-09-20.md` shows the 193K rung reversing on a repeat and explains why the
  dollar metric is not stable across days.
